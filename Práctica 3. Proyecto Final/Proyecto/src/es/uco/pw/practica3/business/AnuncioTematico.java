...
public class AnuncioTematico extends Anuncio{
	...
	public AnuncioTematico(int id, String titulo, String cuerpo, String usuario, ArrayList<Interes> intereses, Date fecha, Estados estado) {
	...
	/**
	 * Este metodo se encarga de convertir la instancia de la clase AnuncioTematico a string
	 * @return string
	 */
